<?php /* Smarty version Smarty-3.1.10, created on 2014-09-26 14:21:55
         compiled from "E:\phpnow\htdocs\module\ask\template\myask.html" */ ?>
<?php /*%%SmartyHeaderCode:774454250603dbeff5-24344260%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c19289219bc7b5f51b9fd2379fa0db4f58888f48' => 
    array (
      0 => 'E:\\phpnow\\htdocs\\module\\ask\\template\\myask.html',
      1 => 1398984278,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '774454250603dbeff5-24344260',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_542506042ca0e6_80852419',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_542506042ca0e6_80852419')) {function content_542506042ca0e6_80852419($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_data')) include 'E:\\phpnow\\htdocs\\lib\\Smarty\\libs\\plugins\\function.load_data.php';
...
<div class="mc-right box790"><!--mc-right-->
					<div class="manageBox margin_bottom"><!--manageBox-->
						<div class="title"><!--title-->
							...
							<span class="title_name"><b>我的留言</b></span></p>
						</div><!--title end-->
						...
						<div class="mr-middle"><!--mr-middle-->
							<div class="account_integral"><!--account_integral-->
								 	...
								 	<div class="m10-sixin-list" id="m10-sixin-list">
								<?php echo smarty_function_load_data(array('assign'=>"list",'table'=>"ask",'showpage'=>"true",'where'=>"uid=".((string)$_smarty_tpl->tpl_vars['member']->value['uid']),'orderby'=>"id desc"),$_smarty_tpl);?>
...
?> 
									...
									<div class="dwb-sixin-list" id="li_ssss_<?php echo $_smarty_tpl->tpl_vars['items']->value['id'];?>
">
										   <ul>	
										   	  <li>		
										   	   	<div class="dp_left">			
										   	   		<div class="dp_left_img">				
										   	   			<img src="<?php echo $_smarty_tpl->tpl_vars['userlogo']->value;?>
"> 			
										   	   		</div>			
										   	   		<p style="border:1px solid #f0f0f0;font-size:11px;"></p>		
										   	    </div>	
										   	    <div class="dp_right">			
										   	    	<div class="bgimg"></div>			
										   	    	<ul>				
										   	    		...
										   	    		<li class="intime">					
										   	    			<p><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['items']->value['replytime'],"%Y-%m-%d %H:%M:%S");?>
</p>
										   	 				</li>			
										   	 		  </ul>			
										   	 		  <div class="clear"></div>			
										   	 		  <p class="scontent"><?php echo htmlspecialchars_decode($_smarty_tpl->tpl_vars['items']->value['replycontent']);?>
</p> 
									...
									<?php }?>
									<div class="my-sixin-list" id="li_s_<?php echo $_smarty_tpl->tpl_vars['items']->value['id'];?>
">
										<ul>	
											<li>		
									        <div class="dp_left">		 
...
"> 			
									         	...
									         	<p style="border:1px solid #f0f0f0;font-size:11px;"><?php echo $_smarty_tpl->tpl_vars['member']->value['username'];?>
</p>		
									        </div>		
									        <div class="dp_right">			
									        	<div class="bgimg"></div>			
									        	<ul>				
									        		<li class="stitle">					
									        			<p>我的留言[<?php echo $_smarty_tpl->tpl_vars['typelist']->value[$_smarty_tpl->tpl_vars['items']->value['typeid']];?>
]</p>				
									        	  </li>				
									        	  <li class="intime">				
									        				<p><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['items']->value['addtime'],"%Y-%m-%d %H:%M:%S");?>
</p>				
									        		</li>		
									        	</ul>		
									          <div class="clear"></div>		
									        	  <p class="scontent"><?php echo htmlspecialchars_decode($_smarty_tpl->tpl_vars['items']->value['content']);?>
</p> 
										   	 		 
									        	<p class="replysixin"><a href="javascript:void(0);" onclick="deleteSixin('<?php echo $_smarty_tpl->tpl_vars['items']->value['id'];?>
')">删除</a></p>		
									        </div>		
									        <div class="clear"></div>	
									    </li>
...
<script>
	function deleteSixin(uid)
	{
		 
		var info = {'tijiao':'do','default':'1','id':uid,'what':'default'};
		var url = '<?php echo FUNC_function(array('type'=>'url','link'=>"/ask/delmyask/datatype/json/random/@random@"),$_smarty_tpl);?>
';
		 myajax(url,info);
	}
</script>
