<?php /* Smarty version Smarty-3.1.10, created on 1938-08-21 05:39:54
         compiled from "E:\phpnow\htdocs\module\system\adminpage\tempset.html" */ ?>
<?php /*%%SmartyHeaderCode:3189c500bf2a7de293-93522960%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9116b1daaa62461a43c78e008259d8cddfcfb9d3' => 
    array (
      0 => 'E:\\phpnow\\htdocs\\module\\system\\adminpage\\tempset.html',
      1 => 1408792434,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3189c500bf2a7de293-93522960',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_c500bf2a8d24d5_54403580',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_c500bf2a8d24d5_54403580')) {function content_c500bf2a8d24d5_54403580($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'E:\\phpnow\\htdocs\\lib\\Smarty\\libs\\plugins\\modifier.date_format.php';
 ...
 <div class="right_content">
	<div class="show_content_m">
   	        	 <div class="show_content_m_ti">
   	        	 	   <div class="showtop_t" id="positionname">模板选择</div>
   	        	 </div>
...
?>
    		<li>
    			 <div><img src="<?php echo $_smarty_tpl->tpl_vars['items']->value['img'];?>
" style="width:298px;height:150px;"></div>
    			 <div style="color:#666;">说明：<?php echo $_smarty_tpl->tpl_vars['items']->value['instro'];?>
</div>
    			 <div><input type="radio" name="modulename" value="<?php echo $_smarty_tpl->tpl_vars['items']->value['filename'];?>
" <?php if ($_smarty_tpl->tpl_vars['sitetemp']->value==$_smarty_tpl->tpl_vars['items']->value['filename']){?> checked<?php }?> onclick="changemodule(this);"><?php echo $_smarty_tpl->tpl_vars['items']->value['filename'];?>
(<?php if ($_smarty_tpl->tpl_vars['sitetemp']->value==$_smarty_tpl->tpl_vars['items']->value['filename']){?> 默认模板<?php }?>)</div>
    			</li>
    		<?php } ?>
