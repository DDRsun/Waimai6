<?php /* Smarty version Smarty-3.1.10, created on 2014-09-26 14:39:53
         compiled from "E:\phpStudy\www\templates\newgreen\site\mapindex.html" */ ?>
<?php /*%%SmartyHeaderCode:1906254250a397de292-26602704%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2cb4bd5037de0e7f282ea729dbf6dbc7a328a5b1' => 
    array (
  ...
  'nocache_hash' => '1906254250a397de292-26602704',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54250a39bebc22_31174759',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54250a39bebc22_31174759')) {function content_54250a39bebc22_31174759($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_data')) include 'E:\\phpStudy\\www\\lib\\Smarty\\libs\\plugins\\function.load_data.php';
  ...
  <div class="hc_advertising">
     <div id="bannerBox">
					 <div  class="slides_container" style="height:175px;">
					 	 <?php echo smarty_function_load_data(array('assign'=>"lunbo",'table'=>"adv",'fileds'=>"*",'limit'=>"5",'where'=>"advtype='lunbo'"),$_smarty_tpl);?>
...
<div class="hc_app">
	<ul>
	 ...
	 <?php echo smarty_function_load_data(array('assign'=>"advlist",'table'=>"adv",'fileds'=>"*",'where'=>"advtype='other1'",'limit'=>"5"),$_smarty_tpl);?>
...
function shopheight(){
	...
	$('#shopList').css('height',Number(numa)*230);
	numshopli = $('#shopList2 li').length;
	 numa = Math.ceil(numshopli/4);
	$('#shopList2').css('height',Number(numa)*230);
}
/*
